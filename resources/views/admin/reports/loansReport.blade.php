                ...
                <div class="card-title">
                    ...
                    <div class="position-relative d-flex align-items-center">
                        <!--begin::Datepicker-->
                         ...
                         dateField" placeholder="Select a date" type="date" name="from_date" value="@if(isset($from_date)) {{$from_date}}@else {{ dateConvertDBtoForm(date('Y-01-01')) }} @endif" />
                         	<!--end::Datepicker-->
                    </div>
                    </div>
                    <div class="position-relative d-flex align-items-center">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Loan Fund Cash</th>
							<th class="min-w-125px">Loan Fund Bank</th>
							<th class="min-w-125px">Value of outstanding Loan</th>
							<th class="min-w-125px">Loan Purpose</th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        ...
                        <tr>
                            ...
                            <td>
                                {{$value->loan_fund_cash}}
                            </td>
                            <!--end::Customer=-->
                            <!--begin::Status=-->
                            <td>
                                {{$value->loan_fund_bank}}
                            </td>
                            <!--end::Status=-->
                            <!--begin::Billing=-->
                            <td>
                                {{$value->value_of_loan_outstanding}}
                            </td>
                            <td>
                                {{$value->loan_purpose}}
                            </td>
