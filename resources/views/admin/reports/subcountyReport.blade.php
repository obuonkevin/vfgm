...
@section('content')
@section('title','Subcounty Report')
@include('admin.partials.lower_top_menu_bar')
<script>
    jQuery(function (){
        $("#subcountyReport").validate();
     });
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        {{ Form::open(array('route' => 'reports.subcountyReport','id'=>'subcountyReport')) }}
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" type="button" class="btn btn-light-primary me-3">
                            ...
                            <h4>
								...
								href="{{ URL('downloadSubCountyReport/?sub_county_id='.$sub_county_id)}}"><i
