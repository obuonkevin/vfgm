	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{route('publicHoliday.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Public Holiday</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('from_date',(isset($editModeData)) ? dateConvertDBtoForm($editModeData->from_date) :  Input::old('from_date'), $attributes = array('class'=>'form-control required dateField','id'=>'from_date','readonly'=>'readonly','placeholder'=>'Enter From date')) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::text('to_date',(isset($editModeData)) ? dateConvertDBtoForm($editModeData->to_date) :  Input::old('to_date'), $attributes = array('class'=>'form-control required dateField','id'=>'to_date','readonly'=>'readonly','placeholder'=>'Enter To date')) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::textarea('comment', Input::old('comment'), $attributes = array('class'=>'form-control comment','id'=>'comment','placeholder'=>'Enter comment','cols'=>'30','rows'=>'2')) !!}
												</div>
											</div>
										</div>
									</div>
