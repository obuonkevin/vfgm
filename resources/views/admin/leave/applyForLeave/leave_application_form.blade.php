	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{route('applyForLeave.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Leave Application</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-info">
					<div class="panel-heading"><i class="mdi mdi-clipboard-text fa-fw"></i>Leave Application Form</div>
						...
						{{ Form::open(array('route' => 'applyForLeave.store','enctype'=>'multipart/form-data','id'=>'leaveApplicationForm')) }}
							<div class="form-body">
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Leave Type<span class="validateRq">*</span></label>
											{{ Form::select('leave_type_id',$leaveTypeList, Input::old('leave_type_id'), array('class' => 'form-control leave_type_id select2 required')) }}
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Current Balance<span class="validateRq">*</span></label>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Number of Day<span class="validateRq">*</span></label>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Purpose<span class="validateRq">*</span></label>
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-6">
										<button type="submit" id="formSubmit" class="btn btn-info "><i class="fa fa-paper-plane"></i> Send Application</button>
									</div>
								</div>
							</div>
						{{ Form::close() }}
