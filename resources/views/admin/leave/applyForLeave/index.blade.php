	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{ route('applyForLeave.create') }}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Apply For Leave</a>
			</div>	
		</div>
											...
											<tr>
												...
												<td>
													@if(isset($value->approveBy->first_name))
														...
														<br/><span class="text-muted">Approve Date : {!! dateConvertDBtoForm($value->approve_date) !!}</span>
													@endif
												</td>
												<td>
													@if(isset($value->rejectBy->first_name))
														{!! $value->rejectBy->first_name !!} {!! $value->rejectBy->last_name !!}
														<br/><span class="text-muted">Reject Date : {!! dateConvertDBtoForm($value->reject_date) !!}</span>
													@endif
												</td>
