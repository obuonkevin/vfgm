            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Vendor" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                {{-- 	<div class="menu-item px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!! route('vendors.show',$value->vendor_id) !!}" class="menu-link px-3">View</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('vendors.delete',$value->vendor_id )!!}"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->vendor_id!!}" class="delete menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
            ...
            <div class="modal fade" id="kt_modal_add_user" tabindex="-1" >
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px" >
                    ...
                    <div class="modal-content">
						...
						@else
						{{ Form::open(array('route' => 'vendors.store','enctype'=>'multipart/form-data','class'=>'form')) }}
						@endif
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
									...
									{{ Form::select('user_id',$data, Input::old('user_id'), array('class' => 'form-control form-select-solid fw-bolder  user_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
									</div>
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
