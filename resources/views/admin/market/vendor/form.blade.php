		...
		<div class="card">
			<div class="card-header border-0 pt-6">
			  ...
			  <!--end::Alert-->
				...
				<div class="card-toolbar">
					...
					<!--begin::Filter-->
					<a href="{{route('vendors.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
						View vendors</a>
						<!--end::Filter-->
			...
			<div class="card-body pt-0">
				<div class="row" style="margin-bottom: 20px">
						<div class="col-md-3">Vendor Name: <span style="font-weight:bold">{{ $vendor->name}}</span>
						</div>
						<div class="col-md-3">Owner: <span
								style="font-weight:bold">{{ $vendor->user->user_name}}</span></div>

						<div class="col-md-3">County: <span
								style="font-weight:bold">{{ $vendor->county->county_name}}</span></div>

						<div class="col-md-3">Location: <span
								style="font-weight:bold">{{ $vendor->location->location_name}}</span></div>
				</div>
			</div>
	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content">
			...
			<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
				<!--begin::Form-->
			{{ Form::model($editModeData, array('route' => array('vendors.update', $editModeData->vendor_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
					...
					<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
						...
						<div class="fv-row mb-7">
							...
							<!--begin::Input-->
											...
											name','id'=>'name','placeholder'=>'Enter Vendor name')) !!}
								<!--end::Input-->
						</div>
						...
						{{ Form::select('user_id',$userList, Input::old('user_id'), array('class' => 'form-select form-select-solid fw-bolder user_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
						</div>

						<div class="fv-row mb-7">
							<!--begin::Label-->
							<label class="required fw-bold fs-6 mb-2">County</label>
						{{ Form::select('county_id',$countyList, Input::old('county_id'), array('class' => 'form-select form-select-solid fw-bolder county_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
						</div>

						<div class="fv-row mb-7">
							<!--begin::Label-->
							<label class="required fw-bold fs-6 mb-2">Location</label>
						{{ Form::select('location_id',$locationList, Input::old('location_id'), array('class' => 'form-select form-select-solid fw-bolder location_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
						</div>
