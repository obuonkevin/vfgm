                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                {{-- 	<div class="menu-item px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!! route('category.show',$value->category_id) !!}" class="menu-link px-3">View</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('category.delete',$value->category_id )!!}"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->category_id!!}" class="delete menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
						@if(isset($editModeData))
						{{ Form::model($editModeData, array('route' => array('category.update', $editModeData->category_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
						@else
						{{ Form::open(array('route' => 'category.store','enctype'=>'multipart/form-data','class'=>'form')) }}
						@endif
                                <!--begin::Scroll-->
