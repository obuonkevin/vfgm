        ...
        <div class="card">
		  ...
		  <!--end::Alert-->
			...
			<div class="card-toolbar">
				...
				<!--begin::Filter-->
				<a href="{{route('product.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
					View products</a>{{--
				<a href="{{route('product.purchase', $editModeData->product_id)}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
						Purchase product</a> --}}
					<!--end::Filter-->
               ...
               <!--begin::Card body-->
				<div class="card-body pt-0">
					<div class="row" style="margin-bottom: 20px">
							<div class="col-md-3">Owner: <span style="font-weight:bold">{{ $product->user->user_name}}</span>
							</div>
							<div class="col-md-3">Vendor: <span
									style="font-weight:bold">{{ $product->vendor->name}}</span></div>
                            <div class="col-md-3">Category: <span
                                    style="font-weight:bold">{{ $product->category_name}}</span></div>
                            <div class="col-md-3">Product Name: <span
                                    style="font-weight:bold">{{ $product->name}}</span></div>

					</div>
                   <hr style="background:#000;">
                   <div class="row" style="margin-bottom: 20px">
                     <div class="col-md-5">Product Description: <span
                        style="font-weight:bold">{{ $product->description}}</span></div>
					<div class="col-md-3">Product Price: <span
						style="font-weight:bold">{{ $product->price}}</span></div>
					<div class="col-md-3">Delivery Cost: <span
						style="font-weight:bold">{{ $product->delivery_cost}}</span></div>
                   </div>
			...
			{{ Form::model($editModeData, array('route' => array('product.update', $editModeData->product_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
					...
					<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
						...
						<div class="fv-row mb-7">
							...
							<!--end::Label-->
							<!--begin::Input-->
								{{ Form::select('user_id',$userList, Input::old('user_id'), array('class' => 'form-control form-control-solid mb-3 mb-lg-0 user_id select2', 'required'=>'required','data-style'=>'btn-info btn-outline')) }}
						...
						{{ Form::select('vendor_id',$vendorList, Input::old('vendor_id'), array('class' => 'form-select form-select-solid fw-bolder vendor_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
						</div>

						<div class="fv-row mb-7">
							<!--begin::Label-->
							<label class="required fw-bold fs-6 mb-2">Category</label>
						{{ Form::select('category_id',$categoryList, Input::old('category_id'), array('class' => 'form-select form-select-solid fw-bolder category_id select2','required'=>'required','data-style'=>'btn-info btn-outline')) }}
						</div>
