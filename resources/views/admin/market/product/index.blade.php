...
@section('formtitle','Edit Product')
@else
@section('formtitle','Add Product')
@endif
<!--begin::Post-->
             ...
             <!--end::Alert-->
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Products" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                            ...
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_subscriptions_table .form-check-input" value="1" />
										...
										<th class="min-w-125px">Delivery Cost</th>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                {{-- 	<div class="menu-item px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!! route('product.show',$value->product_id) !!}" class="menu-link px-3">View</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                                @if($value->status==1)
                                        <a href="{!! route('product.purchase',$value->product_id) !!}" data-token="{!! csrf_token() !!}"
                                            data-id="{!! $value->product_id!!}" class="purchase menu-link px-3">Confirm</a>
                                            @elseif($value->status ==2)
                                            <a href="{!! route('product.cancelPurchase',$value->product_id) !!}" data-token="{!! csrf_token() !!}"
                                                data-id="{!! $value->product_id!!}" class="cancel menu-link px-3">Cancel</a>
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('product.delete',$value->product_id )!!}"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->product_id!!}" class="delete menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_subscriptions_export_form" class="form" action="#">
                            ...
                            <div class="text-center">
                                <button type="reset" id="kt_subscriptions_export_cancel" data-bs-dismiss="modal" class="btn btn-white me-3">Discard</button>
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
						@if(isset($editModeData))
						{{ Form::model($editModeData, array('route' => array('product.update', $editModeData->product_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
						@else
						{{ Form::open(array('route' => 'product.store','enctype'=>'multipart/form-data','class'=>'form')) }}
						@endif
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
											{{ Form::select('user_id',$data, Input::old('user_id'), array('class' => 'form-control form-control-solid mb-3 mb-lg-0 user_id select2', 'id'=>'user_id', 'required'=>'required','data-style'=>'btn-info btn-outline')) }}
                                    ...
                                    {{ Form::select('vendor_id',$vendors, Input::old('vendor_id'), array('class' => 'form-select form-select-solid fw-bolder vendor_id select2', 'id'=>'vendor_id', 'required'=>'required','data-style'=>'btn-info btn-outline')) }}
                                    </div>

                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Category</label>
                                    {{ Form::select('category_id',$categorys, Input::old('category_id'), array('class' => 'form-select form-select-solid fw-bolder category_id select2', 'id'=>'category_id','required'=>'required','data-style'=>'btn-info btn-outline')) }}
                                    </div>
									...
									<div class="fv-row mb-7">
                                        ...
                                        <label class="required fw-bold fs-6 mb-2">Product Name</label>
												...
												name','id'=>'name','placeholder'=>'Enter Product name')) !!}
									</div>
									...
									<div class="fv-row mb-7">
										...
										{!! Form::text('description',Input::old('description'), $attributes
											...
											description','id'=>'description','placeholder'=>'Enter product description')) !!}
									</div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <label class="required fw-bold fs-6 mb-2">Price</label>
												...
												= array('class'=>'form-control form-control-solid mb-3 mb-lg-0 required
												price','id'=>'price','placeholder'=>'Enter Product price')) !!}
									</div>
									<div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Delivery Cost</label>
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Product Status</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        {{ Form::select('status', array('0' => 'Pending'), Input::old('status'), array('class' => 'form-select form-select-solid fw-bolder required')) }}
                                        <!--end::Input-->
                                    </div>
...
<script>
	$(document).on('click', '.purchase', function () {
        ...
        swal({
                title: "Are you sure you want to sell this product?",
                text: "If Yes, Click Confirm",
                type: "info",
	...
	$(document).on('click', '.cancel', function () {
        ...
        var id = $(this).attr('data-id');
        swal({
                title: "Are you sure you want to cancel purchase request?",
                text: "",
                type: "warning",
                showCancelButton: true,
