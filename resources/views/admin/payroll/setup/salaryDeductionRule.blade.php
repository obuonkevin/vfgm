...
@section('content')
@section('title','Salary Deduction For Late Attendance')
<style>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-info">
					<div class="panel-heading"><i class="mdi mdi-table fa-fw"></i> Rules of salary deduction </div>
