		...
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-info">
					<div class="panel-heading"><i class="mdi mdi-table fa-fw"></i> Rate of Income tax</div>
						...
						<div class="panel-body">
							...
							<div class="table-responsive">
								<table  class="table table-bordered">
									...
									<tbody>
										<tr>
											<td colspan="5"><b>Tax Rules (Male)</b></td>
										</tr>
										<?php
										...
										<tr>
											<td colspan="5"><b>Tax Rules (Female)</b></td>
										</tr>
