...
<div class="container-fluid">
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
			<a href="{{route('payGrade.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Pay Grade </a>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
					...
					<div class="panel-body">
						...
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										...
										{!! Form::text('pay_grade_name',Input::old('pay_grade_name'), $attributes = array('class'=>'form-control required pay_grade_name','id'=>'pay_grade_name','placeholder'=>'Enter pay grade name')) !!}
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput">Gross Salary<span class="validateRq">*</span></label>
										{!! Form::number('gross_salary',Input::old('gross_salary'), $attributes = array('class'=>'form-control required gross_salary','id'=>'gross_salary','placeholder'=>'Enter gross salary','min'=>'0')) !!}
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput">Percentage Of Basic<span class="validateRq">*</span></label>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput">Basic Salary<span class="validateRq">*</span></label>
										{!! Form::number('basic_salary',Input::old('basic_salary'), $attributes = array('class'=>'form-control required basic_salary','readonly'=>'readonly','id'=>'basic_salary','placeholder'=>'Enter basic salary','min'=>'0')) !!}
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput">Allowance<span class="validateRq">*</span></label>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput">Deduction<span class="validateRq">*</span></label>
										<table border="1" style="border: 1px solid #ddd;" class="table">
											<thead  class="thead-bar">
											<tr>
												<th >
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput">Overtime Rate (Per Hour)</label>
										{!! Form::number('overtime_rate',Input::old('overtime_rate'), $attributes = array('class'=>'form-control overtime_rate','id'=>'overtime_rate','placeholder'=>'Overtime Rate ( Per Hour)','min'=>'0')) !!}
									</div>
								</div>
