...
@section('content')
@section('title','Hourly Pay Grade List')
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{ route('hourlyWages.create') }}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Hourly Pay Grade</a>
			</div>	
		</div>
