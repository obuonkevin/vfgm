	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<a href="{{ route('generateSalarySheet.create') }}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Generate Salary Sheet</a>
			</div>	
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Payment For <span class="monthAndYearName"></span></b></h4> </div>
			<div class="modal-body">
				<form>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="recipient-name" class="control-label">Basic Salary</label>
								<input type="text" class="form-control basic_salary" readonly>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="recipient-name" class="control-label">Total Allowance</label>
								<input type="text" class="form-control total_allowance" readonly>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="recipient-name" class="control-label">Total Deduction</label>
								<input type="text" class="form-control total_deduction" readonly>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="recipient-name" class="control-label">Gross Salary</label>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info btn_style waves-effect waves-light makePayment" data-dismiss="modal"	> <b>Pay</b></button>
			</div>
		</div>
	</div>
</div>
