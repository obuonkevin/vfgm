...
<div class="container-fluid">
	<div class="row bg-title">
		...
		<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
			<a href="{{route('generateBonus.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Bonus List</a>
		</div>
							...
							<div id="searchBox">
								...
								<div class="col-md-3">
									<div class="form-group employeeName">
										<label class="control-label" for="email">Festival Name<span class="validateRq">*</span></label>
								...
								<div class="col-md-3">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control monthField required" readonly placeholder="Select month"  name="month" value="@if(isset($_REQUEST['month'])) {{$_REQUEST['month']}}@else {{ date('Y-m') }} @endif">
									</div>
								</div>
