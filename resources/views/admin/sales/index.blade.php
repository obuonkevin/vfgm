             ...
             <!--end::Alert-->
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Sales" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                            ...
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_subscriptions_table .form-check-input" value="1" />
										...
										<th class="min-w-125px">Bought By</th>
										<th class="min-w-125px">Sold By</th>
										<th class="min-w-125px">Sold On</th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        ...
                        <tr>
                            ...
                            <!--begin::Action=-->
                            <td>
                              <a href="{{ URL('invoice/?product='.$value->product_id)}}" class="btn btn-light-primary me-3" >Invoice</a>
                             </td>
                            <!--end::Action=-->
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_subscriptions_export_form" class="form" action="#">
                            ...
                            <div class="text-center">
                                <button type="reset" id="kt_subscriptions_export_cancel" class="btn btn-white me-3" data-bs-dismiss="modal">Discard</button>
