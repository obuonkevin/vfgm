                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">{{$userInfo->first_name}} {{$userInfo->last_name}}</a>
                                        <a href="#">
                                    ...
                                    <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                        ...
                                        <!--end::Svg Icon-->{{$userInfo->role->role_name}}</a>
                                        {{-- <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                ...
                                <div class="d-flex my-4">
                                   {{--  <a href="#" class="btn btn-sm btn-light me-2" id="kt_user_follow_button">
                                    ...
                                    <a href="{{url('profile')}}" class="btn btn-sm btn-primary me-3">View Profile</a>
                                   {{--  <!--begin::Menu-->
                                    <div class="me-0">
