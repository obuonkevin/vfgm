...
@section('content')
@section('title','View County')
@if(isset($editModeData))
@section('formtitle','Edit County')
@else
@section('formtitle','Add County')
@endif
        ...
        <div class="card">
          ...
          <!--end::Alert-->
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Filter-->
                <a href="{{route('county.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                    View county</a>
                    <!--end::Filter-->
               ...
               <!--begin::Card body-->
				<div class="card-body pt-0">
                    <div class="row" style="margin-bottom: 20px">
                           <div class="col-md-3">County Name: <span style="font-weight:bold">{{$editModeData->county_name}}</span>
                           </div>
...
<!--end::Post-->
 ...
 <div class="modal fade" id="kt_modal_add_county" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_add_county_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">@yield('formtitle')</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-counties-modal-action="close" data-bs-dismiss="modal"
                    <!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                @if(isset($editModeData))
                {{ Form::model($editModeData, array('route' => array('county.update', $editModeData->county_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
                @else
                {{ Form::open(array('route' => 'county.store','enctype'=>'multipart/form-data','class'=>'form')) }}
                @endif
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">County Name</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            {{-- <input type="text" name="first_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="Emma Smith" />
                             --}}	{!! Form::text('county_name',Input::old('county_name'), $attributes
                                        = array('class'=>'form-control form-control-solid mb-3 mb-lg-0  required
                                        county_name','id'=>'county_name','placeholder'=>'Enter county name')) !!}
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
