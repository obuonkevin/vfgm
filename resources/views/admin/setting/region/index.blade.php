            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <!--end::Svg Icon-->Add Region</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    ...
                                    {{ Form::model($editModeData, array('route' => array('region.update', $editModeData->region_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
                                    @else
                                    {{ Form::open(array('route' => 'region.store','enctype'=>'multipart/form-data','class'=>'form')) }}
                                    @endif
                                        <!--begin::Scroll-->
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <select name="format" data-control="select2" data-placeholder="Select location" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                                    <option value="">--- Select location ---</option>
                                                        @foreach($results as $value)
                                                        <option value="{{$value->location->location_id}}" @if($value->location->location_id ==
                                                            old('location_id')) {{"selected"}} @endif>{{$value->location->location_name}}
                                                        </option>
                                                        @endforeach
                                                </select>
                                                <!--end::Input-->
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                {!! Form::text('region_name',Input::old('region_name'), $attributes
                                                = array('class'=>'form-control form-control-solid mb-3 mb-lg-0 required
                                                region_name','id'=>'region_name','placeholder'=>'Enter region name')) !!}
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">location Name</th>
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">{!! $value->region_name !!}</a>
                            ...
                            <td>
                            {!! $value->location->location_name !!}</a>
                             </td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{!! route('user.edit',$value->user_id) !!}" class="menu-link px-3">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('user.destroy',$value->user_id )!!}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
