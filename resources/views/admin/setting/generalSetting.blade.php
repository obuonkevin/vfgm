												...
												<div class="form-actions">
													<div class="row">
														<div class="col-md-12 text-center">
															...
															<button type="submit" class="btn btn-info btn_style"><i class="fa fa-check"></i> @if($data) {{"update"}} @else {{"Save"}} @endif</button>
														</div>
													</div>
												</div>
											{{ Form::close() }}
											...
											<div class="form-actions">
												<div class="row">
													<div class="col-md-12 text-center">
														...
														<button type="submit" class="btn btn-info btn_style"><i class="fa fa-check"></i> @if($printHeadData) {{"update"}} @else {{"Save"}} @endif</button>
													</div>
												</div>
											</div>
											{{ Form::close() }}
