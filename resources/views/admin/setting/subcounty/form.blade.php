...
@section('content')
@section('title', 'View Subcounty')
@if(isset($editModeData))
@section('formtitle','Edit Sub County')
@else
@section('formtitle','Add Sub County')
@endif
        ...
        <div class="card">
          ...
          <!--end::Alert-->
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Filter-->
                <a href="{{route('subcounty.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                    View subcounty</a>
                    <!--end::Filter-->
               ...
               <!--begin::Card body-->
				<div class="card-body pt-0">
                    <div class="row" style="margin-bottom: 20px">
                           <div class="col-md-3">County Name: <span style="font-weight:bold">{{$editModeData->county->county_name}}</span>
                           </div>
                           <div class="col-md-3">Sub County Name: <span style="font-weight:bold">{{$editModeData->sub_county_name}}</span>
                           </div>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                {{ Form::model($editModeData, array('route' => array('subcounty.update', $editModeData->sub_county_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        {{ Form::select('county_id',$countys, Input::old('county_id'), array('class' => 'form-select form-select-solid fw-bolder county_id select2','data-style'=>'btn-info btn-outline')) }}
                        </div>
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            ...
                            sub_county_name','id'=>'sub_county_name','placeholder'=>'Enter Sub county name')) !!}
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
