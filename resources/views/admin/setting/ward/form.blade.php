...
@section('content')
@section('title', 'View Ward')

@if(isset($editModeData))
@section('formtitle','Edit Ward')
@else
@section('formtitle','Add Ward')
@endif
        ...
        <div class="card">
          ...
          <!--end::Alert-->
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Filter-->
                <a href="{{route('ward.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                    View ward</a>
                    <!--end::Filter-->
               ...
               <!--begin::Card body-->
				<div class="card-body pt-0">
                    <div class="row" style="margin-bottom: 20px">
                           <div class="col-md-3">Sub County Name: <span style="font-weight:bold">{{$editModeData->sub_county->sub_county_name}}</span>
                           </div>
                           <div class="col-md-3">Ward Name: <span style="font-weight:bold">{{$editModeData->ward_name}}</span>
                           </div>
