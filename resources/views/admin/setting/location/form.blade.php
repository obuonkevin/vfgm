...
@section('formtitle','Edit Location')
@else
@section('formtitle','Add Location')
@endif
        ...
        <div class="card">
          ...
          <!--end::Alert-->
            ...
            <div class="card-toolbar">
                ...
                <!--begin::Filter-->
                <a href="{{route('location.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                    View Location</a>
                    <!--end::Filter-->
               ...
               <!--begin::Card body-->
				<div class="card-body pt-0">
                    <div class="row" style="margin-bottom: 20px">
                           <div class="col-md-3">Location Name: <span style="font-weight:bold">{{$editModeData->location_name}}</span>
                           </div>
