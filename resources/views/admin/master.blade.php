...
<head>
    ...
    <!--end::Fonts-->
    <!--begin::Page Vendor Stylesheets(used by user list page)-->
	<link href="{!! asset('assets1/plugins/custom/datatables/datatables.bundle.css') !!}" rel="stylesheet" type="text/css" />
		<!--end::Page Vendor used by user list page Stylesheets-->
...
<body id="kt_body"
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                   <div style="color: #fff;font-size:145%; font-family:Tahoma, sans-serif;">VGMIS SYSTEM</div>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            $topMenu = showModuleMenu($value['module_id']);
                            $subMenuItem = '';
                            ...
                            $subMenuMenuItem .=
                            '<div class="menu-item">
                                <a class="menu-link" href="' . ($subMenu['menu_url'] ? route($subMenu['menu_url'], [ $moduleIdentifier => $menu['module_id']]) : 'javascript:void(0)') . '">
                            ...
                            $subMenuItem .=
                            '<div class="menu-item">
                                <a class="menu-link" href="' . ($menu['menu_url'] ? route($menu['menu_url'], [ $moduleIdentifier => $menu['module_id']]) : 'javascript:void(0)') . '">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">' .
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="" target="_blank" class="text-gray-800 text-hover-primary">VGMIS System</a>
                        </div>
                        <!--end::Copyright-->
                       {{--  <!--begin::Menu-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="assets1/media/avatars/150-11.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="assets1/media/avatars/150-3.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="assets1/media/avatars/150-5.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="assets1/media/avatars/150-2.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="assets1/media/avatars/150-6.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="assets1/media/svg/files/pdf.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="assets1/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="assets1/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-200px"
                                                    src="assets1/media/demos/demo1.png" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-200px"
                                                    src="assets1/media/demos/demo2.png" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-200px"
                                                    src="assets1/media/demos/demo3.png" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="assets1/media/avatars/150-14.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="assets1/media/avatars/150-15.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="assets1/media/avatars/150-2.jpg" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
    ...
    <script src="{!! asset('assets1/js/custom/widgets.js') !!}"></script> --}}
    <script src="{!! asset('assets1/js/custom/apps/chat/chat.js') !!}"></script>
    <script src="{!! asset('assets1/js/custom/modals/create-app.js') !!}"></script>
    <script src="{!! asset('assets1/js/custom/modals/upgrade-plan.js') !!}"></script>
    <!--end::Page Custom Javascript-->
    <!--begin::Page Custom Javascript(used users by this page)-->
    <script src="{!! asset('assets1/js/custom/apps/user-management/users/list/table.js') !!}"></script>
    <script src="{!! asset('assets1/js/custom/apps/user-management/users/list/export-users.js') !!}"></script>
    <script src="{!! asset('assets1/js/custom/apps/user-management/users/list/add.js') !!}"></script>
    <script src="{!! asset('assets1/plugins/custom/datatables/datatables.bundle.js') !!}"></script>
		<!--end::Page Custom Javascript-->

    <!--begin::Page Custom Javascript(used by roles  this page)-->
    <script src="{!! asset('assets1/js/custom/apps/user-management/roles/list/add.js') !!}"></script>
    <script src="{!! asset('assets1/js/custom/apps/user-management/roles/list/update-role.js') !!}"></script>
    <!--end::Javascript-->

		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{!! asset('assets1/js/custom/apps/subscriptions/list/export.js') !!}"></script>
		<script src="{!! asset('assets1/js/custom/apps/subscriptions/list/list.js') !!}"></script>
...
<script>
    (function() {
      var placesAutocomplete = places({
        appId: '27BK9XR5EI',
        apiKey: '7412e88daf052166eedbe422cb7316a5',
      ...
      const mylocality = urlParams.get('location') ? urlParams.get('location') : 'Nairobi, Kenya'
      $address.textContent = mylocality
