												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
															...
															<!--begin::Form-->
															@if(isset($editModeData))
                                                            {{ Form::model($editModeData, array('route' => array('user.update', $editModeData->user_id), 'method' => 'PUT','files' => 'true', 'class'=>'form')) }}
                                                            @else
                                                            {{ Form::open(array('route' => 'user.store', 'class'=>'form', 'enctype'=>'multipart/form-data')) }}
                                                            @endif
																<!--begin::Scroll-->
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                                    ...
                                                                    <div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		{!! Form::password('password', $attributes = array('class'=>'form-control form-control-solid mb-3 mb-lg-0
										                                required password','id'=>'password','placeholder'=>'Enter Password')) !!}<!--end::Input-->
																	</div>
                                                                    <div class="fv-row mb-7">
																		<!--begin::Label-->
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a href="apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">{!! $value->first_name.' '.$value->last_name !!}</a>
													...
													<!--begin::username=-->
													<td>
														<div class="badge badge-light fw-bolder">{!! $value->user_name !!}</div>
													</td>
													<!--end::username=-->
													<!--begin::Two step=-->
													<td>{!! $value->id_no !!}</td>
													...
													<!--begin::Joined-->
                                                    <!--begin::status-->
													<td>	<span class="label label-{{ $value->status==2 ? 'warning' : 'success' }}">{{ $value->status==2 ? 'Inactive' : 'Active' }}</span>
                                                    </td>
													<!--begin::status-->
													<!--begin::Action=-->
													<td class="text-end">
													   ...
													   <div class="menu-item px-3">
														     <a href="{!! route('user.edit',$value->user_id) !!}" class="menu-link px-3">View</a>
														</div>

															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="{!!route('user.destroy',$value->user_id )!!}" class="delete menu-link px-3" data-token="{!! csrf_token() !!}" data-id="{!! $value->user_id !!}">Delete</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
