    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="index.html" class="d-lg-none">
                <img alt="Logo" src="assets1/media/logos/logo-3.svg" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
                   ...
                   {{--  <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                            ...
                            <div
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3"
                                        href="https://preview.keenthemes.com/VFGM8/demo1/layout-builder.html"
                                        ...
                                        <div class="scroll-y mh-200px mh-lg-325px">
                                            ...
                                            <a href="#"
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="assets1/media/avatars/150-1.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                <div
                                            ...
                                            <a href="#"
                                                ...
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="assets1/media/avatars/150-3.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                <div
                                            ...
                                            <a href="#"
                                                ...
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="assets1/media/avatars/150-8.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                <div
                                            ...
                                            <a href="#"
                                                ...
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="assets1/media/avatars/150-11.jpg"
                                                        alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <a href="#"
                                                ...
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="assets1/media/avatars/150-12.jpg"
                                                        alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <span class="symbol-label bg-light">
                                                        <img class="w-20px h-20px"
                                                            src="assets1/media/svg/brand-logos/volicity-9.svg"
                                                            alt="" />
                                                    </span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <span class="symbol-label bg-light">
                                                        <img class="w-20px h-20px"
                                                            src="assets1/media/svg/brand-logos/tvit.svg"
                                                            alt="" />
                                                    </span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <span class="symbol-label bg-light">
                                                        <img class="w-20px h-20px"
                                                            src="assets1/media/svg/misc/infography.svg"
                                                            alt="" />
                                                    </span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <span class="symbol-label bg-light">
                                                        <img class="w-20px h-20px"
                                                            src="assets1/media/svg/brand-logos/leaf.svg"
                                                            alt="" />
                                                    </span>
                                                </div>
                                                <!--end::Symbol-->
                                            ...
                                            <a href="#"
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <span class="symbol-label bg-light">
                                                        <img class="w-20px h-20px"
                                                            src="assets1/media/svg/brand-logos/tower.svg"
                                                            alt="" />
                                                    </span>
                                                </div>
                                                <!--end::Symbol-->
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                            ...
                            <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                                style="background-image:url('assets1/media//misc/pattern-1.jpg')">
                                <!--begin::Title-->
                                ...
                                <div class="tab-pane fade show active" id="kt_topbar_notifications_2"
                                    ...
                                    <div class="d-flex flex-column px-9">
                                        ...
                                        <div class="text-center px-4">
                                            <img class="mw-100 mh-200px" alt="VFGM"
                                                src="assets1/media/illustrations/work.png" />
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                                    <!--end::Wrapper-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="assets1/media/avatars/blank.png" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                    ...
                                    <span class="menu-title position-relative">Language
                                        <span
                                            ...
                                            <img class="w-15px h-15px rounded-1 ms-2"
                                                src="assets1/media/flags/united-states.svg"
                                                alt="VFGM" /></span></span>
                                </a>
                                <!--begin::Menu sub-->
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="assets1/media/flags/spain.svg"
                                                    alt="VFGM" />
                                            </span>Spanish</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="assets1/media/flags/germany.svg"
                                                    alt="VFGM" />
                                            </span>German</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="assets1/media/flags/japan.svg"
                                                    alt="VFGM" />
                                            </span>Japanese</a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src="assets1/media/flags/france.svg"
                                                    alt="VFGM" />
                                            </span>French</a>
                                    </div>
                                    <!--end::Menu item-->
