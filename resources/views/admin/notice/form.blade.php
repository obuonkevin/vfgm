	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
				<a href="{{route('notice.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Notice  </a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
							...
							@endif
								...
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-4">Notice Title<span class="validateRq">*</span></label>
												<div class="col-md-8">
													{!! Form::text('title',Input::old('title'), $attributes = array('class'=>'form-control required title','id'=>'title','placeholder'=>'Enter title')) !!}
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::textarea('description',Input::old('description'), $attributes = array('class'=>'form-control textarea_editor required','rows'=>'15','id'=>'description','placeholder'=>'Enter description')) !!}
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-4">Publish Date<span class="validateRq">*</span></label>
												<div class="col-md-8">
													<div class="input-group">
														<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
														{!! Form::text('publish_date',(isset($editModeData)) ? dateConvertDBtoForm($editModeData->publish_date) : Input::old('publish_date'), $attributes = array('class'=>'form-control dateField','id'=>'publish_date','readonly'=>'readonly','placeholder'=>'Enter publish date')) !!}
													</div>
												</div>
											</div>
										</div>
