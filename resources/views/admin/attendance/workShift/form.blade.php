...
@if(isset($editModeData))
	@section('title','Edit Work Shift')
@else
	@section('title','Add Work Shift')
@endif
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
				<a href="{{route('workShift.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Work Shift</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
							...
							@endif
								...
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-4">Shift Name<span class="validateRq">*</span></label>
												<div class="col-md-8">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-4">Start Time<span class="validateRq">*</span></label>
												<div class="col-md-8">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-4">End Time<span class="validateRq">*</span></label>
												<div class="col-md-8">
													<div class="input-group">
														<div class="input-group-addon">
															<i class="fa fa-clock-o"></i>
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-4">Late Count Time<span class="validateRq">*</span></label>
												<div class="col-md-8">
													<div class="input-group">
														<div class="input-group-addon">
															<i class="fa fa-clock-o"></i>
