				...
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
							...
							<div id="searchBox">
								...
								<div class="col-md-4">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control monthField required" readonly placeholder="Select Month"  name="month" value="@if(isset($month)) {{$month}}@else {{ date("Y-m") }} @endif">
									</div>
								</div>
								<div class="col-md-2">
						...
						@if(count($results) > 0)
							<h4 class="text-right">
								@if(isset($month))
									<a target="_blank" class="btn btn-success" style="color: #fff" href="{{ URL('downloadAttendanceSummaryReport/'.$month)}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i> Download PDF</a>
								@else
									<a class="btn btn-success" style="color: #fff" href="{{ URL('downloadAttendanceSummaryReport/'.date('Y-m') )}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i> Download PDF</a>
								@endif
							</h4>
						@endif
