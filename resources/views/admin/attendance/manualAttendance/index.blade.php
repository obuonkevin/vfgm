									...
									<div id="searchBox">
										...
										<div class="col-md-3">
											<div class="form-group departmentName">
												<label class="control-label" for="email">Department<span class="validateRq">*</span></label>
										...
										<div class="col-md-3">
											<label class="control-label" for="email">Date<span class="validateRq">*</span></label>
													...
													<td style="width: 300px">
														<div class="input-group">
															...
															<div class="bootstrap-timepicker">
																...
																<input class="form-control timePicker" type="text" placeholder="In Time" name="inTime[]" value="{{$value->inTime}}" readonly>
															</div>
														</div>
													</td>
													<td style="width: 300px">
														<div class="input-group">
															...
															<div class="bootstrap-timepicker">
																<input class="form-control timePicker" type="text" placeholder="Out Time" name="outTime[]" value="{{$value->outTime}}" readonly>
															</div>
														</div>
													</td>
												</tr>
