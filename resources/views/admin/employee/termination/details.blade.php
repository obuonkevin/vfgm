...
@section('content')
@section('title','Employee Termination  Details')
<style>
	.post {
		font-weight: 500;
		font-size: 16px;
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-offset-2 col-md-7">
				<p class="box-title post" >Employee Termination Details</p>
				<br>
			</div>
			<div class="col-md-offset-2 col-md-7 ">
				<div class="panel panel-default">
					...
					<div class="panel-wrapper collapse in">
						...
						<div class="panel-footer">
							<p>
								<b>Terminate By :</b>@if(isset($result->terminateBy->first_name))
									{{$result->terminateBy->first_name}} {{ $result->terminateBy->last_name}}
								@endif,
								<b>Notice date :</b>{{date(" d M Y ", strtotime($result->notice_date))}},
								<b>Termination date :</b>{{date(" d M Y ", strtotime($result->termination_date))}}
							</p>
						</div>
					</div>
				</div>
