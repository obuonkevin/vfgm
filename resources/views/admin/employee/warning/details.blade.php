...
@section('content')
@section('title','Employee Warning  Details')
<style>
	.post {
		font-weight: 500;
		font-size: 16px;
	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{route('warning.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Warning  </a>
			</div>
		</div>

		<div class="row">
			<div class="col-md-offset-2 col-md-7">
				<p class="box-title post" >Employee Warning  Details</p>
				<br>
			</div>
			<div class="col-md-offset-2 col-md-7 ">
				<div class="panel panel-default">
					...
					<div class="panel-wrapper collapse in">
						...
						<div class="panel-footer">
							<p>
								<b>Warning By :</b>@if(isset($result->warningBy->first_name))
									{{$result->warningBy->first_name}} {{ $result->warningBy->last_name}}
								@endif,
								<b>Warning Date :</b>{{date(" d M Y ", strtotime($result->warning_date))}}
							</p>
						</div>
					</div>
				</div>
