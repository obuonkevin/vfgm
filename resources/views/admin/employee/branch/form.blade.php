	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
				<a href="{{route('branch.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Branch</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="control-label col-md-4">Branch Name<span class="validateRq">*</span></label>
												<div class="col-md-8">
													{!! Form::text('branch_name',Input::old('branch_name'), $attributes = array('class'=>'form-control required branch_name','id'=>'branch_name','placeholder'=>'Enter branch name')) !!}
												</div>
											</div>
										</div>
									</div>
