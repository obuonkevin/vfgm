								  ...
								  <!--end::Alert-->
									...
									<div class="card-title">
										...
										<div class="d-flex align-items-center position-relative my-1">
											...
											<!--end::Svg Icon-->
											<input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Articles" />
										</div>
										<!--end::Search-->
									</div>
									<!--begin::Card title-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
										...
										<tbody class="text-gray-600 fw-bold">
											...
											<tr>
												...
												<!--begin::Status=-->
												<td>
													<div class="badge badge-light-success">{!! dateConvertDBtoForm($value->publish_date) !!}</div>
												</td>
												<!--end::Status=-->
												<!--begin::Billing=-->
												<td>
												...
												<td class="text-end">
													...
													{{-- 	<div class="menu-item px-3">
														...
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="{!! route('article.show',$value->article_id ) !!}" class="menu-link px-3">View</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="{!!route('article.delete',$value->article_id  )!!}"
																data-token="{!! csrf_token() !!}" data-id="{!! $value->article_id !!}" class="delete menu-link px-3">Delete</a>
														</div>
														<!--end::Menu item-->
													</div>
													<!--end::Menu-->
															...
															<!--end::Input-->
															                          ...
															                          <div class="fv-row mb-7">
																						...
																						<div class="position-relative d-flex align-items-center">
																							...
																							<!--end::Icon-->
																							<!--begin::Datepicker-->
																																		{!! Form::date('publish_date',(isset($editModeData)) ?
