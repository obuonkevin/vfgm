	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{route('performanceCriteria.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Performance Criteria</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
						...
						<div class="panel-body">
							...
							<div class="form-body">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<label class="control-label col-md-4">Criteria Name<span class="validateRq">*</span></label>
											<div class="col-md-8">
												{!! Form::text('performance_criteria_name',Input::old('performance_criteria_name'), $attributes = array('class'=>'form-control required performance_criteria_name','id'=>'performance_criteria_name','placeholder'=>'Enter performance criteria')) !!}
											</div>
										</div>
									</div>
								</div>
