...
@else
	@section('title','Add Employee Promotion')
@endif
	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{route('promotion.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Employee Promotion</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
						...
						<div class="panel-body">
							...
							<div class="form-body">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Current Department<span class="validateRq">*</span></label>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Current Designation<span class="validateRq">*</span></label>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Current Pay Grade<span class="validateRq">*</span></label>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Current Salary<span class="validateRq">*</span></label>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Promoted Pay Grade<span class="validateRq">*</span></label>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">New Salary<span class="validateRq">*</span></label>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Promoted Department<span class="validateRq">*</span></label>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInput">Promoted Designation<span class="validateRq">*</span></label>
								...
								<div class="row">
									<div class="col-md-4">
										<label for="exampleInput">Promotion Date<span class="validateRq">*</span></label>
										...
										<div class="col-md-12">
											@if(isset($editModeData))
												@if($editModeData->status ==1)
													<input type="submit" name="update" class="btn btn-info btn_style" value="Update">
