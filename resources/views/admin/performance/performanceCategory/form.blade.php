...
@if(isset($editModeData))
	@section('title','Edit Performance Category')
@else
	@section('title','Add Performance Category')
@endif
	...
	<div class="container-fluid">
		<div class="row bg-title">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{route('performanceCategory.index')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-list-ul" aria-hidden="true"></i>  View Performance Category</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												{!! Form::text('performance_category_name',Input::old('performance_category_name'), $attributes = array('class'=>'form-control required performance_category_name','id'=>'performance_category_name','placeholder'=>'Enter performance category')) !!}
											</div>
										</div>
									</div>
								</div>
