...
@section('content')
@section('title','Add Employee Performance ')
<style>
	.table>tbody>tr>td {
		padding: 5px 7px;
	}
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-4 col-md-4">
										...
										<div class="input-group">
											...
											<input class="form-control required monthField" readonly="readonly" id="month" placeholder="Enter month" name="month" type="text" value="{{old('month')}}">
										</div>
								...
								<div class="col-xs-12 col-sm-4 col-md-4">
									<div class="form-group">
										...
										<textarea class="form-control" id="Remarks" placeholder="Enter remarks" name="remarks">{{old('remarks')}}</textarea>
									</div>
								</div>
							</div>
														...
														@if($k !=0)
															<tr>
																...
																<td>
																	<div class="input-group">
																		<span class="input-group-addon"><i class="fa fa-star-o"></i></span>
																		<input type="number" name="rating[]"  max="10" class="form-control" placeholder="Enter Rating">
