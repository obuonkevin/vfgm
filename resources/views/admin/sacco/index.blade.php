														...
														<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                            ...
                                                            @endif
																...
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																  <!--begin::Input group-->
                                                                    ...
                                                                    <div class="fv-row mb-10">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <select name="currently_saving" data-control="select2" data-placeholder="--- Select currently saving ---" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        ...
                                                                        <div class="position-relative d-flex align-items-center">
                                                                           ...
                                                                           {{--  <input class="form-control form-control-solid ps-12" placeholder="Select a date" name="due_date" />
                                                                             --}}{!! Form::date('date_started_saving',Input::old('date_started_saving'), $attributes = array('class'=>'form-control form-control-solid ps-12 date_started_saving','placeholder'=>'Enter from date')) !!}
                                                                    ...
                                                                    <div class="col-md-6 fv-row">
                                                                        ...
                                                                        <div class="position-relative d-flex align-items-center">
                                                                            ...
                                                                            <!--begin::Datepicker-->
                                                                           {{--  <input class="form-control form-control-solid ps-12" placeholder="Select a date" name="due_date" />
                                                                             --}}	{!! Form::date('next_meeting_date',Input::old('next_meeting_date'), $attributes = array('class'=>'form-control form-control-solid ps-12 next_meeting_date','placeholder'=>'Enter Next meeting date')) !!}
										                                    <!--end::Datepicker-->
                                                                        </div>
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    ...
                                                                    <div class="fv-row mb-10">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <select name="constitution" data-control="select2" data-placeholder="--- Please Select ---" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                                                    ...
                                                                    <div class="fv-row mb-10">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <select name="property_owned" data-control="select2" data-placeholder="Please Select" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                                                            <option value="">--- Please Select ---</option>
                                                                    ...
                                                                    <div class="fv-row mb-10">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <select name="linkage_to_market" data-control="select2" data-placeholder="Please Select" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                                                            <option value="">---Please Select---</option>
                                                                    ...
                                                                    <div class="fv-row mb-10">
                                                                        <!--begin::Label-->
                                                                        <label class="required fs-6 fw-bold form-label mb-2">Have you been linked to any financial institution?:</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <select name="link_to_financial_institution" data-control="select2" data-placeholder="Please Select" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                                                            <option value="">---Please Select---</option>
                                                                    ...
                                                                    <div class="fv-row mb-10">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <select name="money_usage" data-control="select2" data-placeholder="Please Select" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                                                            <option value="">--- Please select---</option>
																...
																<div class="text-center pt-15">
																	<button type="reset" class="btn btn-secondary" data-dismiss="modal" data-bs-dismiss="modal">Discard</button>
																	<button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">
																		<span class="indicator-label">Submit</span>
																		<span class="indicator-progress">Please wait...
																		<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px">Sub County</th>
													<th class="min-w-125px">Ward</th>
                                                    <th class="min-w-125px">Male Members</th>
                                                    <th class="min-w-125px">Female Members</th>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a href="apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">{!! $value->sacco_name!!}</a>
													...
													<!--begin::username=-->
													<td>
														<div class="badge badge-light fw-bolder">{!! $value->sub_county->sub_county_name !!}</div>
													</td>
													<!--end::username=-->
													<!--begin::Two step=-->
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                            ...
                                                            <div class="menu-item px-3">
																<a href="{!!  route('sacco.show', $value->sacco_id) !!}" class="menu-link px-3">View Group</a>
															</div>
															<div class="menu-item px-3">
																<a href="{!!  route('sacco.edit', $value->sacco_id) !!}"  class="menu-link px-3">Edit</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="{!!  route('sacco.delete', $value->sacco_id) !!}"
																	...
																	data-id="{!!  $value->sacco_id !!}" class="delete menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
