...
@section('formtitles','Edit Member Record for '.$sacco->sacco_name.' members')
@else
@section('formtitles','Add Member Record for '.$sacco->sacco_name.' members')
@endif
<!--begin::Post-->
<div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Member Record" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                        ...
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user1">
            ...
            <div class="card-body pt-0">
                <div class="row" style="margin-bottom: 20px">
                    ...
                    <div class="col-md-4">Member Count: <span style="font-weight:bold">0</span></div> </div>
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Member No.</th>
                            <th class="min-w-125px">Date</th>
                            <th class="min-w-125px">Reason</th>
                            <th class="min-w-125px">Amount(KES)</th>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a data-remote="{!! route('sacco.edit_members',$value->sacco_members_id) !!}" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user1" class="menu-link px-3">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('sacco.delete_members',$value->sacco_members_id )!!}"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->sacco_members_id!!}" class="delete menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
  ...
  <div class="modal fade" id="kt_modal_add_user1" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">@yield('formtitles')</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                ...
                {{ Form::open(array('route' => 'sacco.add_collection','enctype'=>'multipart/form-data')) }}
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold form-label mb-2">Member:</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                                            <select class="form-control form-select form-select-solid fw-bolder  payment_method" name="member_number">
                                                <option value="">--- Select Member ---</option>

                                                @foreach($sacco_members as $value)
                                                @if($value->member_number == $value->user->member_number)
                        ...
                        {!! Form::date('delivery_date',Input::old('delivery_date'), $attributes
                        = array('class'=>'form-control form-select-solid fw-bolder required
                        delivery_date','id'=>'delivery_date','placeholder'=>'Enter Date')) !!}
                    </div>
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="required fs-6 fw-bold form-label mb-2">Record Type:</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                         <select class="form-control form-select form-select-solid fw-bolder  delivery_time" name="delivery_time">
