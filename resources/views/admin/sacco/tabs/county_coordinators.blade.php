...
@section('countyformtitle','Edit County Coordinator')
@else
@section('countyformtitle','Add County Coordinator')
@endif
<!--begin::Post-->
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search County Coordinator" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                        ...
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user3">
                        ...
                        <!--end::Svg Icon-->Add County Coordinator</a>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Email <Address></Address></th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach ($county_coordinators as $value)
                        <tr>
                            <!--begin::Checkbox-->
                            <td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                   ...
                                   {{--  <!--begin::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('sacco.remove_coordinators',$value->county_coordinators_id )!!}"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->county_coordinators_id!!}" class="delete menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">@yield('countyformtitle')</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                {{ Form::open(array('route' => 'sacco.add_coordinators','enctype'=>'multipart/form-data')) }}
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold form-label mb-2">Admin:</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                              <select class="form-control form-select form-select-solid fw-bolder  payment_method" name="user_id">
                                <option value="">--- Select County Coordinator ---</option>
