...
@section('editorformtitle','Edit '.$sacco->sacco_name.' Group Admin')
@else
@section('editorformtitle','Add '.$sacco->sacco_name.' Group Admin')
@endif
<!--begin::Post-->
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Group Admin" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                        ...
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user2">
                        ...
                        <!--end::Svg Icon-->Add Group Admin</a>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                   ...
                                   {{--  <!--begin::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('sacco.remove_editors',$value->sacco_editors_id )!!}"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->sacco_editors_id!!}" class="delete menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">@yield('editorformtitle')</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
