...
@section('formtitle','Edit Members')
@else
@section('formtitle','Add Members')
@endif
<!--begin::Post-->
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Members" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                @if(isset($editModeData))
                {{ Form::model($editModeData, array('route' => array('sacco.update_members', $editModeData->sacco_members_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
                @else
                {{ Form::open(array('route' => 'sacco.add_members','enctype'=>'multipart/form-data', 'class'=>'form')) }}
                @endif
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                     ...
                     <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">Member No</label>
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">Member Name</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="location_id" class="form-control form-select form-select-solid fw-bolder location_id  select2"
                                                onchange="getData(1)" required>
                                                <option value="">--- Select Location---</option>
                                                @foreach($location as $value)
                                                <option value="{{$value->location_id}}" @if($value->location_id ==
