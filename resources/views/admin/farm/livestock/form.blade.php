			...
			<!--end::Card toolbar-->
				...
				<div class="card-body pt-0">
					<div class="row" style="margin-bottom: 20px">
							<div class="col-md-3">Farmer: <span style="font-weight:bold">{{ $livestock->user->user_name}}</span>
							</div>
							<div class="col-md-3">Phone Number: <span
									style="font-weight:bold">{{ $livestock->user->phone_no}}</span></div>
                            <div class="col-md-3">Animal: <span
                                    style="font-weight:bold">{{ $livestock->livestock_name}}</span></div>
                            <div class="col-md-3">Number: <span
                                    style="font-weight:bold">{{ $livestock->number}}</span></div>

					</div>
                   <hr style="background:#000;">
                   <div class="row" style="margin-bottom: 20px">
                     <div class="col-md-5">Gender: <span
                        style="font-weight:bold">{{ $livestock->gender}}</span></div>
					<div class="col-md-3">Age: <span
						style="font-weight:bold">{{ $livestock->age}}</span></div>
                   </div>
                            ...
                            {{ Form::model($editModeData, ['route' => ['livestock.update', $editModeData->livestock_id], 'method' => 'PUT', 'files' => 'true', 'class' => 'form']) }}
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="gender" data-control="select2" data-hide-search="false" class="form-select form-select-solid fw-bolder">
                                            <option value="">{{$editModeData->gender}}</option>
                                          @if($editModeData->gender ==="Female")
