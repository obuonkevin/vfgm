...
@section('content')
@section('title','Livestock List')
@include('admin.partials.lower_top_menu_bar')
@if(isset($editModeData))
@section('formtitle','Edit Livestock')
@else
@section('formtitle','Add Livestock')
@endif
             ...
             <!--end::Alert-->
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Livestocks" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Farmer</th>
                            <th class="min-w-125px">Phone No</th>
                            <th class="min-w-125px">Animal</th>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                {{-- 	<div class="menu-item px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!! route('livestock.show',$value->livestock_id) !!}" class="menu-link px-3">View</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{!!route('livestock.delete',$value->livestock_id )!!}"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->livestock_id!!}" class="delete menu-link px-3">Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            @if (isset($editModeData))
                            {{ Form::model($editModeData, ['route' => ['livestock.update', $editModeData->livestock_id], 'method' => 'PUT', 'files' => 'true', 'class' => 'form']) }}
                        @else
                            {{ Form::open(['route' => 'livestock.store', 'enctype' => 'multipart/form-data', 'class' => 'form']) }}
                        @endif
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Animal</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                                 {!! Form::text(
                                                    'livestock_name',
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="gender" data-control="select2" data-placeholder="Select Gender" data-hide-search="false" class="form-select form-select-solid fw-bolder">
