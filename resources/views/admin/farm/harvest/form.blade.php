...
@section('content')
@section('title', 'View Harvest')
    @if (isset($editModeData))
        @section('formtitle', 'Edit Harvest')
        @else
        @section('formtitle', 'Add Harvest')
        @endif
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container">
             ...
             <!--end::Alert-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Filter-->
                            <a href="{{route('harvest.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                View harvest</a>
                                <!--end::Filter-->
				...
				<div class="card-body pt-0">
					<div class="row" style="margin-bottom: 20px">
							<div class="col-md-3">Farmer: <span style="font-weight:bold">{{ $harvest->user->user_name}}</span>
							</div>
							<div class="col-md-3">Phone No: <span
									style="font-weight:bold">{{ $harvest->user->phone_no}}</span></div>
                            <div class="col-md-3">Produce: <span
                                    style="font-weight:bold">{{ $harvest->harvest_name}}</span></div>
                            <div class="col-md-3">Quantity: <span
                                    style="font-weight:bold">{{ $harvest->amount}}</span></div>

					</div>
                   <hr style="background:#000;">
                   <div class="row" style="margin-bottom: 20px">
                     <div class="col-md-3">Date: <span
                        style="font-weight:bold">{{ $harvest->created_at}}</span></div>
                   </div>
            ...
            <!--end::Card body-->
                    ...
                    <!--end::Card body-->   <!--begin::Modal - Add task-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            <!--begin::Form-->
                            {{ Form::model($editModeData, ['route' => ['harvest.update', $editModeData->harvest_id], 'method' => 'PUT', 'files' => 'true', 'class' => 'form']) }}
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fw-bold fs-6 mb-2">Harvest Name</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                             {!! Form::text(
                                                'harvest_name',
                                                Input::old('harvest_name'),
                                                $attributes = array(
