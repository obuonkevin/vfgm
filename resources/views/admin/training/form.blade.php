...
@section('formtitle','Edit Training')
@else
@section('formtitle','Add Training')
@endif
        ...
        <div class="card">
			<div class="card-header border-0 pt-6">
			  ...
			  <!--end::Alert-->
                ...
                <div class="card-toolbar">
					...
					<!--begin::Filter-->
					<a href="{{route('training.index')}}" type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
						View Trainings</a>
						<!--end::Filter-->
            ...
            <div class="card-body pt-0">
                <div class="row" style="margin-bottom: 20px">
                        <div class="col-md-3">Training Title: <span style="font-weight:bold">{{ $training->title}}</span>
                        </div>
                        <div class="col-md-3">Training Description: <span
                                style="font-weight:bold">{{ $training->description}}</span></div>

                        <div class="col-md-3">Status: <span
                                style="font-weight:bold">{{ $training->status}}</span></div>

                        <div class="col-md-3">Added By: <span
                                style="font-weight:bold">{{ $training->createdBy->user_name}}</span></div>
                     </div>
			</div>
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											...
											<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
												<!--begin::Form-->
												@if(isset($editModeData))
												{{ Form::model($editModeData, array('route' => array('training.update', $editModeData->training_id), 'method' => 'PUT','files' => 'true','class' => 'form')) }}
												@else
												{{ Form::open(array('route' => 'training.store','enctype'=>'multipart/form-data','class'=>'form')) }}
												@endif
													<!--begin::Scroll-->
													<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
														...
														<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="required fw-bold fs-6 mb-2">Training Title</label>
															<!--end::Label-->
															<!--begin::Input-->
														...
														<div class="fv-row mb-7">
															...
															<!--end::Label-->
															<!--begin::Input-->
															{!! Form::textarea('url',Input::old('url'), $attributes =
																array('class'=>'form-control form-control-solid mb-3 mb-lg-0 textarea_editor
																required','rows'=>'15','id'=>'url','placeholder'=>'Enter training link
																url')) !!}
														</div>
														<!--end::Input group-->
