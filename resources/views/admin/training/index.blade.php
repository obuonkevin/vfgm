									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
										...
										<tbody class="text-gray-600 fw-bold">
											...
											<tr>
												...
												<!--begin::Customer=-->
												<td>
													<a href="apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">{{$value->title}}</a>
												</td>
												<!--end::Customer=-->
												<!--begin::Status=-->
												<td>
												...
												<!--end::Billing=-->
												<!--begin::Product=-->
												<td>{{$value->createdBy->user_name}}</td>
												<!--end::Product=-->
												<!--begin::Date=-->
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="{{$value->url}}" class="menu-link px-3">View</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="{!! route('training.edit',$value->training_id ) !!}" class="menu-link px-3">Edit</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a href="{!!route('training.delete',$value->training_id  )!!}"
																data-token="{!! csrf_token() !!}" data-id="{!! $value->training_id !!}" class="delete menu-link px-3">Delete</a>
														</div>
														<!--end::Menu item-->
													</div>
													<!--end::Menu-->
