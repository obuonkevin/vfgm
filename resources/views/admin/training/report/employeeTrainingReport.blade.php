...
@section('content')
@section('title','Employee Training Report')
<style>
	.employeeName{
		position: relative;
	}
				...
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
						...
						@if(count($results) > 0 && $results !='')
							<h4 class="text-right">
								<a class="btn btn-success" style="color: #fff" href="{{ URL('downloadTrainingReport/?employee_id='.$employee_id)}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i> Download PDF</a>
							</h4>
						@endif
                        @if($results !='')
                            <div class="table-responsive">
                                <table id="" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="4">No data have found !</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
