	...
	<section id="wrapper" class="new-login-register">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<h3 style="text-align: center; color: green;margin-top:50px">
						Farmers Group Management System
					</h3>
					<div class="white-box" style="background-color: #fff!important;margin-top:30px!important">
							...
							<div class="form-group">
								<div class="col-md-12">
									<a href="javascript:void(0)" id="backToLogin" class="text-dark pull-right"><i
											class="fa fa-arrow-left m-r-5"></i> Back</a> </div>
							</div>
