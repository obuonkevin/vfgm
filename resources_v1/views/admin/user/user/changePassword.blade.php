						...
						{{ Form::open(array('route' => array('changePassword.update',Auth::user()->user_id),'enctype'=>'multipart/form-data','id'=>'changePassword','class'=>'form-horizontal', 'method' => 'PUT')) }}
							<div class="form-body">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<label class="control-label col-md-4 label-medium">User Name<span class="validateRq">*</span></label>
											<div class="col-md-8">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<label class="control-label col-md-4 label-medium">Old password<span class="validateRq">*</span></label>
											<div class="col-md-8">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<label class="control-label col-md-4 label-medium">New password<span class="validateRq">*</span></label>
											<div class="col-md-8">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<label class="control-label col-md-4 label-medium">Confirm Password<span class="validateRq">*</span></label>
											<div class="col-md-8">
									...
									<div class="col-md-8">
										<div class="row">
											<div class="col-md-offset-4 col-md-8">
												<button type="submit" class="btn btn-success btn_style"><i class="fa fa-pencil"></i> Update </button>
											</div>
										</div>
									</div>
								</div>
