            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <i class="mdi mdi-table fa-fw"></i> County Coordinator
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button class="btn btn-success pull-right waves-effect waves-light" data-toggle="modal"
                            data-target="#responsive-modal-coordinators"><i class="fa fa-plus-circle"
                                aria-hidden="true"></i> Add County Coordinator</button>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr class="{!! $value->sacco_id !!}">
                                    ...
                                    <td style="width: 100px;">
                                        <a href="{!!route('sacco.remove_coordinators',$value->county_coordinators_id )!!}" title="Remove"
                                            data-token="{!! csrf_token() !!}" data-id="{!! $value->county_coordinators_id!!}"
...
<div id="responsive-modal-coordinators" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel0"
    aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h5 class="modal-title"><b>Add Coordinators to {{ $sacco->sacco_name}} <span
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="recipient-name" class="label-medium">Coordinators</label>
