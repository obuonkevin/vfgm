					...
					<div class="row">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<a href="{{ route('region.create') }}"
								...
								<i class="fa fa-plus-circle" aria-hidden="true"></i> Add Region</a>
						</div>
					</div>
				</div>
						...
						<div class="table-responsive">
							<table id="myTable" class="table table-bordered">
								...
								<tbody>
									...
									<tr class="{!! $value->region_id !!}">
										<td style="width: 300px;">{!! ++$sl !!}</td>
										<td>{!! $value->region_name !!}</td>
										<td>{!! $value->location->location_name !!}</td>
										<td style="width: 100px;">
											<a href="{!! route('region.edit',$value->region_id) !!}"
												class="btn btn-success btn-xs btnColor">
												<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
											</a>
											<a href="{!!route('region.delete',$value->region_id )!!}"
												data-token="{!! csrf_token() !!}" data-id="{!! $value->region_id!!}"
