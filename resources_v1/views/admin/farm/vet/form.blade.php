			...
			<div class="panel panel-info">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<a href="{{route('vet.index')}}"
								class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i
									class="fa fa-list-ul" aria-hidden="true"></i> View Vets</a>
						</div>
					</div>
				</div>
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
						@if(isset($editModeData))
						{{ Form::model($editModeData, array('route' => array('vet.update', $editModeData->county_id), 'method' => 'PUT','files' => 'true','class' => 'form-horizontal')) }}
						@else
						{{ Form::open(array('route' => 'vet.store','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
						@endif
						<div class="form-body">
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label class="label-medium">Name<span
									...
									<div class="form-group">
										...
										<select name="location_id" class="form-control location_id  select2"
											...
											<option value="{{$value->location_id}}" @if($value->location_id ==
												old('location_id')) {{"selected"}} @endif>{{$value->location_name}}</option>
											@endforeach
										</select>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label for="exampleInput" class="label-medium">Region<span
											class="validateRq">*</span></label>
