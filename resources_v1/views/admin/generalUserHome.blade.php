...
<div class="container-fluid">
        ...
        <div class="col-md-6 col-sm-12 col-lg-6">
            <div class="panel">
                <div class="p-30">
                    <div class="row">
                        @if($userInfo->photo !='')
                            <div class="col-xs-4 col-sm-4"><img src="{!! asset('uploads/employeePhoto/'.$userInfo->photo) !!}" alt="varun" class="img-circle img-responsive"></div>
                        @else
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <h2 class="m-b-0">{{$userInfo->first_name}} {{$userInfo->last_name}}</h2>
                            <h4>{{$userInfo->role->role_name}}</h4><a href="{{url('profile')}}" class="btn btn-rounded btn-success"><i class="ti-user m-r-5"></i> PROFILE </a></div>
                    </div>
  ...
  {{--   @if(count($warning) > 0)
                        ...
                        <div class="comment-center p-t-10">
                            <div class="comment-body">
                                ...
                                <div class="mail-contnet">
                                    ...
                                    <br/><span class="mail-desc">
                                Warning By: {{$row->warningBy->first_name}} {{$row->warningBy->last_name}}<br>
                                Description: {!!  substr($row->description,0,80)!!}..
                        </span>
                                    <a href="{{url('warning/'.$row->warning_id)}}" class="btn m-r-5 btn-rounded btn-outline btn-danger">Read More</a> </div>
                            </div>
                        </div>
                    @endforeach
                </div>
   ...
   {{--  @if(count($terminationData) > 0)
        <div class="col-md-12 col-lg-6 col-sm-12">
            <div class="white-box">
                <h3 class="box-title">Termination</h3>
                <hr>
                        ...
                        <div class="comment-center p-t-10">
                            <div class="comment-body">
                                ...
                                <div class="mail-contnet">
                                    ...
                                    <br/><span class="mail-desc">
                                            Terminated By: {{$terminationData->terminateBy->first_name}} {{$terminationData->terminateBy->last_name}}<br>
                                            Description: {!!  substr($terminationData->description,0,80)!!}..
                                        </span>
