...
<div id="responsive-modal-bulk" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('member_no',Input::old('member_no'), $attributes
                            = array('class'=>'form-control required
                            member_no','id'=>'member_no','placeholder'=>'Enter member number')) !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
